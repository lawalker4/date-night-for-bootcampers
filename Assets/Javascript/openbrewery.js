...
function checkAPIkey() {{$.get("https://thezipcodes.com/api/v1/usages?&apiKey=" + apikey, function(e){ console.log("Zip Code API Usage: " + e.result.used + " / 1000")})}}
checkAPIkey();
...
$("#submit-button").on("click", function() {
 event.preventDefault();
  ...
  $.ajax("https://thezipcodes.com/api/v1/search?zipCode=" + zipCode + "&apiKey=" + apikey, timeout = t, 
  ).then(function(e) {
